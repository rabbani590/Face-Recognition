...
import cv2,os#for paths in system
import shutil#like events in java --open,close,read,write
import csv#file format
import numpy as np#to work with arrays
import PIL#to train images
from PIL import Image, ImageTk#to take images
import pandas as pd#for dataframes series
import datetime
import time
import tkinter.ttk as ttk#for colors and themed widgets in gui
...
#message = tk.Label(window, text="Codegnan IT Solutions" ,fg="Black"  ,width=50  ,height=3,font=('Times New Roman', 30, ' bold ')) 
